...
public class ArraysTest {
    public static void main(String[] args) {
        String [] animals = {"dog", "cat", "caw", "pig"};
        ...
        String [] foodILIke = {"hamburger", "pie", "potatoes", "kale", "peanut butter"};
        String [] foodYouLIke = Arrays.copyOfRange(foodILIke, 1, 3);
        System.out.println(Arrays.toString(foodYouLIke));

        String [] students = {"Ron", "Jon", "Kevin", "Jeff", "Mittsy"};
